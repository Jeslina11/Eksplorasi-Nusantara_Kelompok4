...
const cardsData = {
  popular: [
    { title: 'Pulau Karampuang', location: 'Jl. Bau Massepe, Labukkang', rating: 4.7, imgSrc: 'image/pulau karampuang.jpg', detailsUrl: 'rumede.html' },
    { title: 'Pantai Manakarra', location: 'Lumpue, Bacukiki Barat', rating: 4.6, imgSrc: 'image/manakarra.jpg', detailsUrl: 'kali biru.html'  },
    { title: 'Air terjun Malute', location: 'Jl. Latassakka, Lumpue', rating: 4.6, imgSrc: 'image/malute.webp', detailsUrl: 'Candi borobudur.html'  },
    // { title: 'Manrelo', location: 'Watang Soreang, Soreang', rating: 4.6, imgSrc: 'image/manrelo.png', detailsUrl: 'Candi borobudur.html'  },
    // { title: 'Puncak karomba', location: 'Lapangan Andi Makkasau', rating: 4.6, imgSrc: 'image/karomba.png', detailsUrl: 'Candi borobudur.html'  },
  ],
};
