...
const cardsData = {
  popular: [
    { title: 'Air terjun Moramo', location: 'Jl. Bau Massepe, Labukkang', rating: 4.7, imgSrc: 'image/moramo.jpeg', detailsUrl: 'rumede.html' },
    { title: 'Puncak Ahuawali', location: 'Jl. Latassakka, Lumpue', rating: 4.6, imgSrc: 'image/ahuawali.jpg', detailsUrl: 'Candi borobudur.html'  },
    { title: 'Pura Agung Jagadhita', location: 'Watang Soreang, Soreang', rating: 4.6, imgSrc: 'image/pura penataran angung jagadhita.jpg', detailsUrl: 'Candi borobudur.html'  },
    { title: 'Pulau Labengki', location: 'Lumpue, Bacukiki Barat', rating: 4.6, imgSrc: 'image/pulau labengki.jpg', detailsUrl: 'kali biru.html'  },
    { title: 'CitraLand Waterpark', location: 'Lapangan Andi Makkasau', rating: 4.6, imgSrc: 'image/citraLand Waterpark.jpg', detailsUrl: 'Candi borobudur.html'  },
  ],
};
