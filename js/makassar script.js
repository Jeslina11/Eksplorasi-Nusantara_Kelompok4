...
//<!------------------ HOME SECTION ------------------>
  ...
  const cardsData = {
    popular: [
      { title: 'Trans Studio', location: 'Jl. Metro, Tanjung Bunga', rating: 4.6, imgSrc: 'image/trans studio mks Bg.jpg', detailsUrl: '.html'  },
      { title: 'Benteng Rotterdam', location: 'Jl. Ujung Pandang, Bulo Gading', rating: 4.6, imgSrc: 'image/rotterdamBg.jpg', detailsUrl: '.html'  },
      { title: 'Museum Balla Lompoa', location: 'Jl. K. H. Wahid Hasyim, Sungguminasa', rating: 4.7, imgSrc: 'image/Museum balla lompoa  bg.jpeg', detailsUrl: '.html' },
      { title: 'Nipah Mall', location: 'Jl. Urip Sumoharjo, Panakkukang', rating: 4.6, imgSrc: 'image/nipah mall Bg.jpg', detailsUrl: '.html'  },
      { title: 'Masjid Kubah 99 Asmaul Husna', location: 'Jl. H. Bau, Tanjung Bunga', rating: 4.6, imgSrc: 'image/99 kubah.jpg', detailsUrl: '.html'  },
    ],
  };
