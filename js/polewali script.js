...
//<!------------------ HOME SECTION ------------------>
  const cardsData = {
    popular: [
    { title: 'Limbong Kamandang', location: 'Kurrak, Tapango', rating: 4.7, imgSrc: 'image/limbong kamanda.webp', detailsUrl: '' },
    { title: 'Indorannuang', location: 'Kunyi, Anreapi', rating: 4.6, imgSrc: 'image/indorannuang bg.jpg', detailsUrl: ''  },
    { title: 'Rawa Bangun', location: 'Batetangnga, Binuang', rating: 4.6, imgSrc: 'image/rawa bangun.jpg', detailsUrl: ''  },
    { title: 'Kampung Rumede', location: 'Kunyi, Anreapi', rating: 4.6, imgSrc: 'image/rumede2 bg.png', detailsUrl: ''  },
  ],
};
